                    ...
                    <div class="card rounded-3">
                        <div class="card-body p-4 p-md-5">
                            ...
                            <form class="px-md-2" method="POST" action="">
                                ...
                                <input type="text" name="teacher_id" id="teacher_id" class="form-control mb-3">
                            ...
                            if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['teacher_id'])) {
                                $teacher_id = trim($_POST['teacher_id']); // Trim whitespace

                                // Debugging Output
                                echo "<p>Received Teacher ID: <strong>$teacher_id</strong></p>";

                                // QR Code Display Logic
                                if ($teacher_id == 'T1740783949') {
                                    echo "<img src='img/qr2.jpg' style='width: 80%; margin-left: 10%;'>";
                                } elseif ($teacher_id == 'T1718791191') {
                                    echo "<img src='img/qr2.jpg' style='width: 80%; margin-left: 10%;'>";
                                }elseif ($teacher_id == 'T1738461273') {
                                    echo "<img src='img/qr2.jpg' style='width: 80%; margin-left: 10%;'>";
                                } else {
                                    echo "<p style='color: red; font-weight: bold;'>No QR Found</p>";
                                }
                            } else {
                                echo "<p style='color: blue;'>Please enter a Teacher ID to display the QR code.</p>";
                            }
                            ?>
                        </div>
                    </div>
